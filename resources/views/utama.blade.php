...
<head>
  ...
  <!--   ikon di tab browser -->
  <link rel="shortcut icon" href="{{asset("https://static.vecteezy.com/system/resources/previews/017/192/895/original/luxury-letter-r-logo-r-logotype-for-elegant-and-stylish-fashion-symbol-vector.jpg")}}" />
</head>
<body>
  @yield('form_inputan')
  @yield('form_edit')
